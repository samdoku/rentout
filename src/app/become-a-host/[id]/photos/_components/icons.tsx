export const Icons = {
	...
	add: () => (
		<svg
			...
			role="presentation"
			focusable="false"
			style={{ display: "block", height: "32px", width: "32px", fill: "none", stroke: "rgb(106, 106, 106)", strokeWidth: "2", overflow: "visible" }}
			width="32"
			height="32"
		>
	...
	addMore: () => (
		<svg
			...
			role="presentation"
			focusable="false"
			style={{ display: "block", height: "16px", width: "16px", fill: "none", stroke: "currentcolor", strokeWidth: "4", overflow: "visible" }}
			width="32"
			height="32"
		>
